...
Justificativa: O input() captura o dado do usuário e o int() garante que possa realizar cálculos matemáticos com ele. Sem o int(), o Python trataria o número como texto, gerando erros.
...
def exibir_numeros():
    ...
    # O segundo parâmetro é exclusivo (para antes dele), portanto, usa 101 para incluir o 100.
